...
const users: UserReview[] = [
  {
    ...
    review:
      "Aceromax's monthly dashboards help me understand my finances at a glance. No spreadsheets, no confusion — just clear insights.",
    rating: 4,
    halfStar: true,
  },
  {
    ...
    review:
      "Since using Aceromax, I've been able to track profits and reduce unnecessary expenses with ease. It's like having a CFO in my pocket.",
    rating: 5,
  },
  {
    name: "David Chen",
    ...
    review:
      "Aceromax streamlines financial reporting for all our clients. Uploading data is simple, and the visual reports are a game-changer for monthly reviews.",
    rating: 5,
  },
];
...
export default function UsersSay() {
  return (
    <section id="users-say" className="bg-[#f9fafb] mb-16">
      ...
      <p className="flex justify-center items-start text-[20px] font-normal mt-3 mb-5 text-[#4b5563] text-center">
        See how contractors, architects, and retailers are benefiting from the Aceromax loyalty program
      </p>
