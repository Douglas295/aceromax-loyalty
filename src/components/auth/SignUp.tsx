...
export default function SignUp() {
  ...
  const validateForm = () => {
    ...
    setErrors(newErrors);
    return !newErrors.email && !newErrors.password && !newErrors.confirmPassword && !newErrors.name && !newErrors.type;
  };
  ...
  return (
    <div className="w-full min-h-[650px] h-[calc(90vh-100px)] max-w-md flex flex-col items-center justify-center pt-24">
      ...
      <form onSubmit={handleSubmit} className="w-full bg-white rounded-2xl shadow-lg p-6 sm:p-8 flex flex-col gap-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full h-12 px-4 rounded-md border border-gray-300 bg-white text-base text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-500"
          />
        </div>
        {/* Business Type */}
        <div>
          <label className="block text-sm font-semibold text-gray-700 mb-2" htmlFor="businessType">
            Account Type
          </label>
          <select
            id="businessType"
